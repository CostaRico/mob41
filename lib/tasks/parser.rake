task :run_parser => :environment do 
	...
	# end	
	# puts "===============total=============="
	#  "Чугунные ванны", "products_list" "Уголки, ограждения, поддоны"
	...
	#"Писсуары", "Полотенцесушители","Раковины","Сифоны","Стальные ванны","Теплые полы","Трапы, душевые лотки","Унитазы","Фильтры под мойку","Сифоны","Смесители"]
...
def product_parser(base_url, file, path_to_file)
	...
	list.each_with_index do |item, i|
		# if i > 7171
			...
			sleep(rand(9.0..13.0))
			begin 
				page = open_uri(base_url + item["url"])
